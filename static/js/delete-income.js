...
const DELETEBUTTON = document.getElementById('deleteIncomeButton');
...
$(document).ready(function() {
    ...
    $('#delete-modal').on('show.bs.modal', function(event) {
        if (SEARCHFIELD.value.trim() !== '') { // And the search bar is not empty
            var button = $(event.relatedTarget); // We select the button that open the modal and assign it's value to the delete button inside the modal to be able to delete the expense.
