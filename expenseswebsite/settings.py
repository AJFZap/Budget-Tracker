...
ALLOWED_HOSTS = ['127.0.0.1', 'https://bg-tracker.up.railway.app/']

CSRF_TRUSTED_ORIGINS = [
    'https://bg-tracker.up.railway.app/',
]
...
MIDDLEWARE = [
    ...
    'expenseswebsite.middleware.SetUserLanguageMiddleware',
    'expenseswebsite.middleware.LanguagePrefixMiddleware',
